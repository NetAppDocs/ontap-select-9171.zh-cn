...
summary: 使用 Python 代码示例创建或删除ONTAP Select集群时，必须提供一个 JSON 文件作为脚本的输入。您可以根据部署计划复制和修改相应的 JSON 示例。 
---
= 用于创建ONTAP Select集群的脚本的 JSON
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
使用 Python 代码示例创建或删除ONTAP Select集群时，必须提供一个 JSON 文件作为脚本的输入。您可以根据部署计划复制和修改相应的 JSON 示例。
